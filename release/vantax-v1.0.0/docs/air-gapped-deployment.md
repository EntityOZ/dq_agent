...
# Save to tarballs
docker save ghcr.io/luketempleman/meridian-api:latest | gzip > meridian-api.tar.gz
docker save ghcr.io/luketempleman/meridian-frontend:latest | gzip > meridian-frontend.tar.gz
